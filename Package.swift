...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/brightenai/swift-nio.git", .upToNextMajor(from: "2.16.1")),
        .package(url: "https://github.com/brightenai/swift-nio-ssl.git", .upToNextMajor(from: "2.7.2")),
        .package(url: "https://github.com/brightenai/swift-nio-transport-services.git", .upToNextMajor(from: "1.0.0")),
        .package(url: "https://github.com/brightenai/async-http-client.git", .upToNextMajor(from: "1.2.0")),
    ],
    targets: [
